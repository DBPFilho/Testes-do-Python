...
def find_length(num):
	...
	def most_common(lst):
            ...
            most_common_repeat = most_common(all_six_repearts)
            repeat_count = all_six_repearts.count(most_common_repeat)

            print("Most common repeat of length", num, ":", most_common_repeat)
            print("Occurrences:", repeat_count)

            return most_common_repeat, repeat_count
...
num = 6
most_common_repeat, repeat_count = find_length(num)
print("Most common repeat of length", num, ":", most_common_repeat)
print("Occurrences:", repeat_count)
